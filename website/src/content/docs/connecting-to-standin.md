...
- **Bridge-side (`MAX_CALL_MINUTES`):** your own hard cap per call, useful because Deepgram knows nothing about your budget. See [Governors and Privacy](/deepgram-msteams-bridge-py/governors-and-privacy/).
